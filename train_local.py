...
def train():
    ...
    # Hiperparámetros
    lr_dir = 'LR'  # Ruta local para las imágenes de baja resolución
    hr_dir = 'HR'  # Ruta local para las imágenes de alta resolución
    model_save_dir = './model'  # Carpeta local para guardar el modelo
    num_epochs = 50  # Número de épocas
    batch_size = 16  # Tamaño del lote
    learning_rate = 1e-4
    num_workers = 0  # Reducido a 0 para evitar multiprocessing issues
    ...
    print('Entrenamiento completado y modelo guardado localmente.')
